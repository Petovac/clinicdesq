...
class ClinicAppointmentController extends Controller
{
    public function index()
    {
        ...
        $waitingCount = Appointment::where('clinic_id',$user->clinic_id)
            ->where('status','checked_in')
            ->count();

        $consultationCount = Appointment::where('clinic_id',$user->clinic_id)
            ->where('status','in_consultation')
            ->count();

        $completedCount = Appointment::where('clinic_id',$user->clinic_id)
