...
class LabResult extends Model
{
    protected $fillable = [
        ...
        'mime_type', 'file_size', 'extracted_text', 'summary',
        'uploaded_by_lab_id', 'vet_approved', 'vet_approved_at', 'vet_notes',
    ...
    {
        return $this->belongsTo(LabUser::class, 'uploaded_by_lab_id');
    }
}
